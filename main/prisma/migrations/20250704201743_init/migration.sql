...
CREATE TABLE `Product` (
    ...
    `status` ENUM('ACTIVE', 'INACTIVE', 'DRAFT', 'PUBLISHED', 'ARCHIVED', 'PENDING', 'RESOLVED', 'REJECTED') NOT NULL,
...
CREATE TABLE `User` (
    ...
    `name` VARCHAR(191) NOT NULL,
    `status` ENUM('ACTIVE', 'INACTIVE', 'DRAFT', 'PUBLISHED', 'ARCHIVED', 'PENDING', 'RESOLVED', 'REJECTED') NOT NULL DEFAULT 'ACTIVE',
